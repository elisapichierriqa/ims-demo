...
create table if not exists ims.orderline(orderlineID int primary key auto_increment, quantity int NOT NULL, itemID int, item_value int, foreign key(itemID) references items(id));
